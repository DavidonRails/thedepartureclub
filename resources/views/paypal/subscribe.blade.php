<input class="btn-paypal" type="image" ng-click="subscribe('{{$user_token}}', {{$package_id}})" src="{{url('images/paypall-btn.png')}}" border="0" alt="PayPal - The safer, easier way to pay online!" style="width: 100%;">
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" id="paypalform">
    ...
    <input type="hidden" name="a3" value="{{$package_price}}">
